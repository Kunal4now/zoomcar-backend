...
public class CarDTO {
	...
	public CarDTO(String carId, String model, Integer price, Availability availability, Integer capacity, CarType type,
	...
	public String toString() {
		return "CarDTO [carId=" + carId + ", model=" + model + ", price=" + price + ", availability=" + availability
